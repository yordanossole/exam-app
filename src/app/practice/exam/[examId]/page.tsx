  ...
  return (
    <PaidGradeGate grade={exam.grade}>
      <main style={shell}>
        ...
        <section style={grid}>
          <Link href={`/practice/exam/${exam.exam_id}/exam`} style={card}>
            <span style={cardTitle}>Start Exam</span>
            <span style={meta}>Work through every question, check answers, use hints, and review explanations.</span>
